...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | huasan")[0];
}
...
function createtime1() {
  var grt = new Date("03/29/2026 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("03/29/2026 00:00:00");
